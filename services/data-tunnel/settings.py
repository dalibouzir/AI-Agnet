...
class Settings(BaseModel):
    ...
    s3_endpoint: str = os.getenv("S3_ENDPOINT") or os.getenv("MINIO_ENDPOINT", "http://minio:9000")
    s3_access_key: str = os.getenv("S3_ACCESS_KEY") or os.getenv("MINIO_ACCESS_KEY", "minio")
    s3_secret_key: str = os.getenv("S3_SECRET_KEY") or os.getenv("MINIO_SECRET_KEY", "minio123")
    s3_bucket: str = os.getenv("S3_BUCKET") or os.getenv("MINIO_BUCKET", "documents")
    opensearch_url: str = os.getenv("OPENSEARCH_URL", "http://opensearch:9200")
    opensearch_username: str | None = os.getenv("OPENSEARCH_USERNAME")
    opensearch_password: str | None = os.getenv("OPENSEARCH_PASSWORD")
    redis_url: str = os.getenv("REDIS_URL", "redis://redis:6379/0")
    nats_url: str = os.getenv("NATS_URL", "nats://nats:4222")
    embed_provider: str = os.getenv("EMBEDDING_BACKEND") or os.getenv("EMBED_PROVIDER", "api")
    embed_model: str = (
    ...
    ollama_host: str = os.getenv("EMBEDDING_OLLAMA_URL") or os.getenv("OLLAMA_HOST", "http://llama:11434")
